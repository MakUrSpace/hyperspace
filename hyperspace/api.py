...
from hyperspace.bounty_system.discuss_bounty import get_ask_recipient_form, submit_recipient_question, get_question_answer_form, submit_recipient_answer
...
def build_page():
    ...
    # Ask the Recipient
    page.add_endpoint(method="get", path="/rest/ask_recipient/{bounty_id}", func=get_ask_recipient_form, content_type="text/html")
    page.add_endpoint(method="post", path="/rest/ask_recipient/{bounty_id}", func=submit_recipient_question, content_type="text/html")
    page.add_endpoint(method="get", path="/rest/question/{question_id}", func=get_question_answer_form, content_type="text/html")
    page.add_endpoint(method="post", path="/rest/question/{question_id}", func=submit_recipient_answer, content_type="text/html")
